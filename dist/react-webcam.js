...
var Webcam = function (_Component) {
  ...
  _createClass(Webcam, [{
    ...
    value: function getScreenshot() {
      ...
      var type = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'blob';
      ...
      return new Promise(function (resolve, reject) {
        if (type === 'blob') {
          ...
          resolve(canvas && canvas.toDataURL(_this2.props.screenshotFormat));
        }
      });
    }
  }, {
